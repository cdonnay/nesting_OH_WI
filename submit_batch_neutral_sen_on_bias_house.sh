...
job_name="neutral_sen_on_bias_house_$(date '+%d-%m-%Y@%H:%M:%SET')"
...
# on line 167 or so
running_script_name="single_run_neutral_sen_on_bias_house.sh"


# ==================
# RUNNING PARAMETERS
# ==================
log_dir="logs/neutral_sen_on_house_bias"
states=("OH" "WI")
bias_parties=("Dem" "Rep" "Neutral")
